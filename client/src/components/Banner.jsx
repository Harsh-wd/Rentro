...
const Banner = () => {
 ...
 justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#FF4D01] to-[#ff7b42]
  max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      <div className='text-white'>
        <h2 className='text-3xl font-medium'>Do you own any Unused Vehicle?</h2>
        <p className='mt-2'>Monetize your vehicle effortlessly by listing it on Rentro.</p>
        ...
        className='px-6 py-2 bg-white hover:bg-slate-100 transition-all
         text-primary rounded-1g text-sm mt-4 cursor-pointer'>
            List your vehicle
        </motion.button>
      </div>
      <motion.img
