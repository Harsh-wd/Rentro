...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Vehicle" SubTitle="Fill in details to list a new vehicle for 
          ...
          <p className='text-sm text-gray-500'>Upload a picture of your vehicle</p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div className='flex flex-col w-full'>
                <label>Brand</label>
                <input type="text" placeholder='e.g BMW, Mercedes..' required
            ...
            <div className='flex flex-col w-full'>
                ...
                <textarea rows={5} placeholder="e.g A Sedan with good condition and powerful engine" required
                className='px-3 py-2 mt-1 border border-borderColor rounded-md
